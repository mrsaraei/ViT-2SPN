...
def evaluate_test_data(model, test_loader, classes):
    ...
    plt.savefig("./ssp_retinaloct_tbme/vit2spn_tiny/scratch/result/ucsdoct_scratch_confusion_matrix.png")
    plt.show()
...
plt.grid()
plt.savefig("./ssp_retinaloct_tbme/vit2spn_tiny/scratch/result/ucsdoct_scratch_roc_curve_all_folds.png")
plt.show()