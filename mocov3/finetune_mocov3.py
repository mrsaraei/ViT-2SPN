...
from ssp_mocov3 import MoCoV3Backbone
...
def evaluate_test_data(model, test_loader, classes):
    ...
    plt.savefig("./ssp_retinaloct_midl2025/mocov3/result/confusion_matrix.png")
    plt.show()
...
for fold, (train_idx, val_idx) in enumerate(skf.split(range(len(small_labeled_dataset)), 
    ...
    model.backbone.load_state_dict(torch.load("./ssp_retinaloct_midl2025/mocov3/octmnist_mocov3_model.pth"))
...
plt.grid()
plt.savefig("./ssp_retinaloct_midl2025/mocov3/result/roc_curve_all_folds.png")
plt.show()