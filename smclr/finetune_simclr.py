...
from ssp_simclr import ResNetBackbone
...
def evaluate_test_data(model, test_loader, classes):
    ...
    plt.savefig("./ssp_retinaloct_midl2025/simclr/result/confusion_matrix.png")
    plt.show()
...
for fold, (train_idx, val_idx) in enumerate(skf.split(range(len(small_labeled_dataset)), 
    ...
    load_pretrained_backbone(model, "./ssp_retinaloct_midl2025/simclr/octmnist_simclr_model.pth")
...
plt.grid()
plt.savefig("./ssp_retinaloct_midl2025/simclr/result/roc_curve_all_folds.png")
plt.show()