...
def evaluate_test_data(model, test_loader, classes):
    ...
    plt.savefig("./ssp_retinaloct_tbme/vit2spn_tiny/dsn_ssn/result/ucsdoct_confusion_matrix.png")
    plt.show()
...
plt.grid()
plt.savefig("./ssp_retinaloct_tbme/vit2spn_tiny/dsn_ssn/result/ucsdoct_roc_curve_all_folds.png")
plt.show()