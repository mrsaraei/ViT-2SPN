...
output_directory = "./ssp_retinaloct_midl2025/vit2net/"
output_pretrained_model_path = os.path.join(output_directory, "octmnist_vit2net_model.pth")
...
def train_self_supervised(model, dataloader, epochs, optimizer, criterion):
    ...
    plt.grid(True)
    plt.savefig('./ssp_retinaloct_midl2025/vit2net/result/ssp_loss_curv.png')
    plt.show()
